...
PROC SORT DATA = SASDATA.&DATA; BY PERMITNO; 

DATA ISSUED; SET SASDATA.&DATA;
     RENAME STATUS = S;
     RENAME BLANKRPT = BLANK;
	 DROP IMAGEPATH KEYDATE KEYID ADLNO PMRECID PHONE YEAR DATEISS INITIAL LICENSE_NO EMAIL HHMEMBERS;
RUN;
...
PROC SORT DATA = ISSUED1; BY PERMIT;
DATA ISSUED_1; SET ISSUED1;
     IF _N_ LE 10000;
DATA ISSUED_2; SET ISSUED1;
     IF _N_ GT 10000 AND _N_ LE 20000;
DATA ISSUED_3; SET ISSUED1;
     IF _N_ GT 20000;
RUN;
...
PROC EXPORT DATA= WORK.ISSUED_1
            OUTFILE= "O:\DSF\RTS\common\PAT\PERMITS\&PROJECT\&YEAR\PU PERMITS &YEAR" 
            DBMS=EXCELCS REPLACE;
            SHEET="PERMIT RECORDS1"; 
RUN;
PROC EXPORT DATA= WORK.ISSUED_2
            OUTFILE= "O:\DSF\RTS\common\PAT\PERMITS\&PROJECT\&YEAR\PU PERMITS &YEAR" 
            DBMS=EXCELCS REPLACE;
            SHEET="PERMIT RECORDS2"; 
RUN;
PROC EXPORT DATA= WORK.ISSUED_3
            OUTFILE= "O:\DSF\RTS\common\PAT\PERMITS\&PROJECT\&YEAR\PU PERMITS &YEAR" 
            DBMS=EXCELCS REPLACE;
            SHEET="PERMIT RECORDS3"; 
RUN;
