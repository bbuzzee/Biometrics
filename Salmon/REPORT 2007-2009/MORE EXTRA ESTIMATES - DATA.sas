...
PROC IMPORT OUT= WORK.ONE 
     DATAFILE= "O:\DSF\RTS\PAT\Permits\Salmon\2007\PU PERMITS 2007 EXTRA ESTIMATES.XLS" 
     DBMS=EXCEL REPLACE;
...
DATA ALL; MERGE ONE THREE FISHERY_HARVEST; BY PERMIT;
	 ...
	 TOTAL_DAYS = KENAI_DAYS + KASILOF_DIPNET_DAYS + KASILOF_GILLNET_DAYS + UNKNOWN_DAYS;
...
DATA SASDATA.EXTRA2007; SET ALL;
...
PROC EXPORT DATA= WORK.EXTRA_2007_2007_2007 
     OUTFILE= "O:\DSF\RTS\PAT\Permits\Salmon\REPORT 2007-2007\MORE EXTRA ESTIMATES.xls" 
     DBMS=EXCEL REPLACE;
     SHEET="DATA"; 
RUN;
*/
