...
TITLE1 '2007, 2008, 2009 DATA COMBINED';
TITLE2 'ONLY THOSE PERMITS THAT FISHED IN ONE FISHERY ARE INCLUDED IN THE ANALYSIS';


DATA ALL; SET SASDATA.EXTRA2007 SASDATA.EXTRA2008 SASDATA.EXTRA2009;
     IF FISHERIES EQ 1;
	 DROP FISHERIES;
...
PROC EXPORT DATA= WORK.FIGURE10_C 
     OUTFILE= "O:\DSF\RTS\PAT\Permits\Salmon\REPORT 2007-2009\MORE EXTRA ESTIMATES.xlsx" 
     DBMS=EXCEL REPLACE;
     SHEET="FIGURE10_C"; 
RUN;
*/
