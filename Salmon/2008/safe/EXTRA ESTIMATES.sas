...
PROC FREQ DATA = ALLPERMITS3; BY FISHERY;
     TABLES CITY / NOPRINT OUT = FISHERY_BY_CITY;
...
*     REGION AND AREA WERE DEFINED BY KRISSY IN THE SPREADSHEET O:\DSF\RTS\Pat\Permits\Salmon\CITIES 2007 - 2009_KD.xls      *;
...
*                                                                                                                            *;
*     THESE ESTIMATES WERE REQUESTED BY KRISSY IN JAN 2010.  SHE WANTED THE ESTIMATES FOR ALL SPECIES 2007 - 2009            *;
******************************************************************************************************************************;
...
DATA LOCATION; MERGE CITY PERMIT_CITY; BY CITY;
     IF NEW_NAME NE ' ' THEN DO;
                               CITY = NEW_NAME;
                             END;
