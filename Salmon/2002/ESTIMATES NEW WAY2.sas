...
%LET MATRIX = 6;   *NUMBER OF FISHERIES + 1;
%LET TOTAL = _6;   *NUMBER OF FISHERIES + 1;
RUN;
...
DATA HARVESTED; SET RETURNED;
     ...
     IF OLDFSHRY EQ 'KASILOF' AND HARVDATE GE '16JUN02'D AND HARVDATE LE '24JUN02'D THEN FISHERY = 3;  *GILLNET;
...
PROC PRINT;
      ...
      LABEL VARIABLE = 'VARIABLE' 
           MEAN1="MEAN &F1" MEAN2 = "MEAN &F2" MEAN3 = "MEAN &F3"
           MEAN4="MEAN &F4" MEAN5 = "MEAN &F5" MEAN6 = "MEAN &F6"
            BHH1="ESTIMATED HARVEST &F1" BHH2 = "ESTIMATED HARVEST &F2" BHH3 = "ESTIMATED HARVEST &F3"
            BHH4="ESTIMATED HARVEST &F4" BHH5 = "ESTIMATED HARVEST &F5" BHH6 = "ESTIMATED HARVEST &F6";
RUN; 
