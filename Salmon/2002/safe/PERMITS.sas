...
DATA ISSUED; SET ISSUED;
     ...
     IF S = 'Z' THEN RESPONDED = 'N'; 
        ELSE RESPONDED = 'Y';
     DROP PMRECID ADDRESS ZIPCODE PHONE HHMEMBERS KEYDATE COMMENTS YEAR DATEISS PERMITNO S;
RUN;
...
DATA PERSONAL; SET ISSUED;
     KEEP PERMIT ADLNO CITY STATE COUNTRY DRIVERSST FIRST_NAME LAST_NAME;

DATA ISSUED; SET ISSUED;
     DROP DUPPREF ADLNO CITY STATE COUNTRY DRIVERSST FIRST_NAME LAST_NAME;
