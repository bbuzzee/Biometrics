...
*     This program is stored as S:\RTS\common\PAT\PERMITS\salmon\2013\harvest.sas  *;
****************************************************************************************;
...
PROC EXPORT DATA= WORK.COMMENTS
            OUTFILE= "S:\RTS\common\PAT\PERMITS\&PROJECT\&YEAR\PU PERMITS &YEAR" 
...
PROC EXPORT DATA= WORK.HARVEST_CHANGED
            OUTFILE= "S:\RTS\common\PAT\PERMITS\&PROJECT\&YEAR\PU PERMITS &YEAR.XLS" 
            DBMS=EXCEL2000 REPLACE;
...
PROC EXPORT DATA= WORK.DAILY 
            OUTFILE= "S:\RTS\common\PAT\PERMITS\Salmon\&YEAR\DAILY REPORTED.xls" 
            DBMS=EXCEL2000 REPLACE;
RUN;
