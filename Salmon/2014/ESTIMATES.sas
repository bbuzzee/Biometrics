...
*  This program is stored as S:\RTS\common\PAT\PERMITS\salmon\2013\estimates.sas          *;
****************************************************************************************;


%LET PROJECT = SALMON;
%LET PROGRAM = ESTIMATES;
%LET DATA = cislhvc_raw;
%LET YEAR = 2014;
%LET SPECIES = SALMON;
...
/*
PROC EXPORT DATA= WORK.RETURNED OUTFILE= "S:\RTS\common\PAT\PERMITS\Salmon\&YEAR\RETURNED_PERMITS.xls" DBMS=EXCEL2000 REPLACE;
RUN;
