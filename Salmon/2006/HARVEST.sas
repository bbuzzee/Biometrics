...
PROC EXPORT DATA= WORK.COMMENTS
            OUTFILE= "H:\common\PAT\Permits\Salmon\&YEAR\PU PERMITS.xls" 
...
PROC IMPORT OUT= WORK.PHONE DATAFILE= "H:\common\PAT\Permits\Salmon\2006\UNKNOWN FISHERY PHONE SURVEY.xls" DBMS=EXCEL REPLACE;
