...
*     This program is stored as h:\common\pat\permits\salmon\2001\permit.sas           *;
****************************************************************************************;
...
PROC CONTENTS DATA = PERMITS;
     TITLE3 '';
RUN;


DATA COMMENTS; SET PERMITS;
     WHERE COMMENTS NE '';
...
DATA ISSUED; SET ISSUED;
     ...
     DROP PMRECID ADDRESS ZIPCODE PHONE KEYDATE COMMENTS YEAR DATEISS PERMITNO S KEYID INITIAL LICENSE_NO;
RUN;
...
PROC FREQ;
     TABLES FAMILYSI OFFICE MAILING STATUS DUPPREF VENDORCOPY RESPONDED ALLOWED CITY STATE / NOPERCENT NOROW NOCOL; 
PROC FREQ;
