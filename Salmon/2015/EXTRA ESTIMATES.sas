...
PROC EXPORT DATA= WORK.DAYS_BY_FISHERY_AND_PERMIT_CITY
            OUTFILE= "O:\DSF\RTS\common\Pat\PERMITS\&PROJECT\&YEAR\PU PERMITS &YEAR EXTRA ESTIMATES" 
...
*     REGION AND AREA WERE DEFINED BY KRISSY IN THE SPREADSHEET O:\DSF\RTS\common\Pat\Permits\Salmon\CITIES 2007 - 2008_KD.xls      *;
*     AND WERE TRANSLATED INTO SAS IN THE PROGRAM O:\DSF\RTS\common\Pat\Permits\Salmon\CITIES.SAS                                   *;
*     AND STORED AS A PERMANENT SASDATABASE O:\DSF\RTS\common\Pat\Permits\Salmon\CITIES.SAS                                         *;
*                                                                                                                            *;
*     THESE ESTIMATES WERE REQUESTED BY KRISSY IN JAN 2011.  SHE WANTED THE ESTIMATES FOR ALL SPECIES 2007 - 2008            *;
******************************************************************************************************************************;
