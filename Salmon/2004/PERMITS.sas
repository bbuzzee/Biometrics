...
DATA SASDATA.&DATA; SET SASDATA.&DATA;
     CITY = UPCASE(CITY);
     IF PERMITNO = 2554 OR PERMITNO = 5860 THEN FAMILYSI = 2;
     IF PERMITNO = 6358 THEN FAMILYSI = 1;
     IF PERMITNO = 18723 THEN FAMILYSI = 7;
     IF PERMITNO = 18724 THEN FAMILYSI = 3;
     IF PERMITNO = 14537 OR PERMITNO = 15160 THEN FAMILYSI = .;
