...
if (familysi le 16);
maxhrv = 0;
if (familysi eq 1 and red ge 25) then maxhrv = 1; 
if (familysi eq 2 and red ge 35) then maxhrv = 1; 
if (familysi eq 3 and red ge 45) then maxhrv = 1; 
if (familysi eq 4 and red ge 55) then maxhrv = 1; 
if (familysi eq 5 and red ge 65) then maxhrv = 1; 
if (familysi eq 6 and red ge 75) then maxhrv = 1; 
if (familysi eq 7 and red ge 85) then maxhrv = 1; 
if (familysi eq 8 and red ge 95) then maxhrv = 1; 
if (familysi eq 9 and red ge 105) then maxhrv = 1; 
...
proc univariate data=combo;
   ...
   class familysi;
   var red;
   title 'Kenai sockeye PU fishery bag limit - summarize sockeye harvest by household size';
proc freq data=combo;
   where familysi gt 0 and familysi le 9;
   table maxhrv*familysi;
run;
